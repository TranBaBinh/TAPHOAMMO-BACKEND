        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EKYCFrontImage = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    EKYCBackImage = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    EKYCPortraitImage = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserBankInfos_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VatInvoiceInfos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VatInvoiceInfos_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedFields = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    DepositCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalFavorites = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ComplaintReason = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    AdminAccountNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    AdminAccountName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    AdminBankName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    SellerId = table.Column<int>(type: "int", nullable: true),
                    ProductId = table.Column<int>(type: "int", nullable: true),
                    RelatedTransactionId = table.Column<int>(type: "int", nullable: true),
                    ReportDeadline = table.Column<DateTime>(type: "datetime2", nullable: true),
                    WithdrawalAccountNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    WithdrawalAccountName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    WithdrawalBankName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WalletTransactions_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityLogs_Operation",
                table: "ActivityLogs",
                column: "Operation");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_UserId_ProductId_ProductOptionId",
                table: "CartItems",
                columns: new[] { "UserId", "ProductId", "ProductOptionId" },
                unique: true,
                filter: "[ProductOptionId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OtpCodes_Email_Code_IsUsed",
                table: "OtpCodes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAuthInfos_GoogleId",
                table: "UserAuthInfos",
                column: "GoogleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VatInvoiceInfos_UserId",
                table: "VatInvoiceInfos",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_VatInvoiceInfos_UserId_IsDefault",
                table: "VatInvoiceInfos",
                columns: new[] { "UserId", "IsDefault" });

            migrationBuilder.CreateIndex(
                name: "IX_Wallets_DepositCode",
                table: "Wallets",
                column: "DepositCode");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WalletTransactions_ProductId",
                table: "WalletTransactions",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WalletTransactions_ReportDeadline",
                table: "WalletTransactions",
                column: "ReportDeadline");

            migrationBuilder.CreateIndex(
                name: "IX_WalletTransactions_SellerId",
                table: "WalletTransactions",
                column: "SellerId");
